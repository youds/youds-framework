...
/**
 * Console handles command line responses.
 *
 ...
 * @version    $Id$
 */
class Console extends Response implements IResponse
{
	/**
	...
	{
		throw new BadMethodCall('Redirects are not implemented for Console.');
	}
