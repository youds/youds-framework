...
/**
 * HttpRedirectCallback allows redirection of a matched route to a
 ...
 * @version    $Id$
 */
class HttpRedirectCallback extends Callback
{
	/**
	...
	public function initialize(Context $context, array &$route)
	{
		...
		// sanity check
		if(!($context->get() instanceof Web)) {
			throw new Exception('HttpRedirectCallback can only be used in combination with Web.');
		}
	}
	...
	public function onMatched(array &$parameters, ExecutionContainer $container)
	{
		...
		if(!($response instanceof Response\Web)) {
			throw new Exception('HttpRedirectCallback can only be used in combination with Response\Web.');
		}
