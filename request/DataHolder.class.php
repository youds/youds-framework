...
/**
 * DataHolder provides methods for retrieving client request 
 ...
 * @version    $Id$
 */
class DataHolder extends ParameterHolder implements IParameters
{
	/**
	...
	public function clear($source)
	{
		if(isset($this->$source)) {
			...
			throw new InvalidArgument('Unknown source ' . $source . ' specified');
		}
	}
