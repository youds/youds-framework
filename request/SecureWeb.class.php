...
/**
 * SecureWeb provides additional support for HTTPS client requests
 ...
 * @since      0.1.0
 *
 * @deprecated To be removed in Youds Framework 1.1
 *
 * @version    $Id$
 */
class SecureWeb extends Web {
...
// -------------------------------------------------------------------------
	 ...
	 * @author     Markus Lervik <markus.lervik@necora.fi>
	 * @author     David Zülke <dz@bitxtender.com>.0
	 */
