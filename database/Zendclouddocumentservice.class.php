...
/**
 * Zendclouddocumentservice provides connectivity to databases
 ...
 *                      already loaded with include_once() or be autoloadable.
 ...
 * @version    $Id$
 */
class Zendclouddocumentservice extends Base implements Database
{
	/**
	...
	public function connect()
	{
		...
		} catch(Exceptions\Zend_ $e) {
			throw new Database(sprintf("Caught exception of type %s while creating adapter instance; details:\n\n%s", get_class($e), $e->getMessage()), 0, $e);
		}
	}
	...
	public function listDocuments(?array $options = null)
	{
		if(!$this->hasParameter('collection')) {
			throw new Database('Convenience functions require configuration parameter "collection".');
		}
