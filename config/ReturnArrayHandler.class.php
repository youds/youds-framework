...
/**
 * ReturnArrayHandler allows you to retrieve the contents of a config
 * file as an array.
 ...
 * @version    $Id$
 */
class ReturnArrayHandler extends XmlHandler {
	/**
	...
	/**
	 * Converts an XmlDomElement into an array.
	 *
	 * @param      XmlDomElement The configuration element to convert.
	 ...
	 * @author     David Zülke <david.zuelke@bitxtender.com>
	 */
	protected function convertToArray(XmlDomElement $item, $topLevel = false)
	{
