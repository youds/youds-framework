...
<!--
  ...
  VERSION INFORMATION 
   ...
   2009-02-25 RJ
        ...
        * Tested on SAXON 9, Xalan 0.1. Partly tested MSXML.  
   2008-09-19 RJ
   ...
   Version: 2008-07-24
   		...
   		* RJ add support for experimental non-standard attribute report/@chain
   		and assert/@chain, and add parameter not in the published API (should
   ...
   Version:2006-11-07 (ISO: first release private to schematron-love-in maillist for relayout)
...
<!-- Using EXSLT with all modeles (except function content: not applicable) -->
...
<!-- These are the chains that are performed unless overridden -->
<!-- ============================================================== -->
	...
	<!-- default output chain: the simplest customization is to just override this -->
