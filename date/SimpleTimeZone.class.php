...
class SimpleTimeZone extends TimeZone
{
	 ...
	 *
	 * @param      TimeZone The SimpleTimeZone object to be compared with.
	 * 
	 ...
	 * Overloaded.
	 * 
	 * @see        SimpleTimeZone::setStartRuleIIII()
	 * @see        SimpleTimeZone::setStartRuleIIIIF()
	 * @see        SimpleTimeZone::setStartRuleIII()
	 * @see        SimpleTimeZone::setStartRuleIIIF()
	 * @see        SimpleTimeZone::setStartRuleIIIIB()
	 * @see        SimpleTimeZone::setStartRuleIIIIFB()
	 * 
	 * @author     Dominik del Bondio <ddb@bitxtender.com>
	 * @author     The ICU Project
	 */
	 ...
	 * Overloaded.
	 * 
	 * @see        SimpleTimeZone::setEndRuleIIII()
	 * @see        SimpleTimeZone::setEndRuleIIIIF()
	 * @see        SimpleTimeZone::setEndRuleIII()
	 * @see        SimpleTimeZone::setEndRuleIIIF()
	 * @see        SimpleTimeZone::setEndRuleIIIIB()
	 * @see        SimpleTimeZone::setEndRuleIIIIFB()
	 * 
	 * @author     Dominik del Bondio <dominik.del.bondio@bitextender.com>
	 * @author     The ICU Project
	 */
	 ...
	 * Overloaded.
	 * 
	 * @see        SimpleTimeZone::getOffsetIIIIII()
	 * @see        SimpleTimeZone::getOffsetIIIIIII()
	 * @see        SimpleTimeZone::getOffsetIIIIIIII()
	 * 
	 * @author     Dominik del Bondio <dominik.del.bondio@bitextender.com>
	 * @author     The ICU Project
	 */
	...
	public function getOffsetIIIIII($era, $year, $month, $day, $dayOfWeek, $millis)
	{
		...
		if($month < DateDefinitions::JANUARY || $month > DateDefinitions::DECEMBER) {
				throw new InvalidArgument('Month out of range');
				return 0;
		}
	...
	public function getOffsetIIIIIIII($era, $year, $month, $day, $dayOfWeek, $millis, $monthLength, $prevMonthLength)
	{
		if(($era != GregorianCalendar::AD && $era != GregorianCalendar::BC)
				...
				|| $prevMonthLength < 28
				|| $prevMonthLength > 31) {
				throw new InvalidArgument('One of the supplied parameters is out of range');
				return -1;
		}
	...
	public function setDSTSavings($millisSavedDuringDST)
	{
		if($millisSavedDuringDST <= 0) {
			throw new InvalidArgument('The amount must be a positive number');
		} else {
	 ...
	 * 
	 * @param      TimeZone The TimeZone object to be compared with
	 * 
...
*/
	...
	private function construct($rawOffsetGMT, $startMonth, $startDay, $startDayOfWeek, $startTime, $startTimeMode, $endMonth, $endDay, $endDayOfWeek, $endTime, $endTimeMode, $dstSavings)
	{
		...
		if($dstSavings <= 0) {
			throw new InvalidArgument('The DST savings amount must be a positive number');
		}
	}
	...
	private function decodeStartRule() 
	{
		...
		if($this->startDay != 0) {
			if($this->startMonth < DateDefinitions::JANUARY || $this->startMonth > DateDefinitions::DECEMBER) {
				throw new InvalidArgument('startMonth out of range');
			}
			if($this->startTime < 0 || $this->startTime > DateDefinitions::MILLIS_PER_DAY || $this->startTimeMode < self::WALL_TIME || $this->startTimeMode > self::UTC_TIME) {
				throw new InvalidArgument('startTime out of range');
			}
	 ...
	 *
	 * @see        SimpleTimeZone::decodeStartRule
	 * 
	 * @author     Dominik del Bondio <ddb@bitxtender.com>
	 * @author     The ICU Project
	 */
	private function decodeEndRule() 
	{
		...
		if($this->endDay != 0) {
			if($this->endMonth < DateDefinitions::JANUARY || $this->endMonth > DateDefinitions::DECEMBER) {
				throw new InvalidArgument('endMonth out of range');
			}
			if($this->endTime < 0 || $this->endTime > DateDefinitions::MILLIS_PER_DAY || $this->endTimeMode < self::WALL_TIME || $this->endTimeMode > self::UTC_TIME) {
				throw new InvalidArgument('endTime out of range');
			}
			if($this->endDayOfWeek == 0) {
				...
				if($this->endDayOfWeek > DateDefinitions::SATURDAY) {
					throw new InvalidArgument('endDayOfWeek out of range');
				}
			}
			if($this->endMode == self::DOW_IN_MONTH_MODE) {
				if($this->endDay < -5 || $this->endDay > 5) {
					throw new InvalidArgument('endDay out of range');
				}
