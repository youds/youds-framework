...
class GregorianCalendar extends Calendar
{
	...
	//const kPapalCutover = (2299161.0 - kEpochStartAsJulianDay) * DateDefinitions::MILLIS_PER_DAY;
	const PAPAL_CUTOVER      = -12219292800000.0;

	/**
	 * Overloaded.
	 *
	 * @see        GregorianCalendar::constructorO()
	 * @see        GregorianCalendar::constructorOO()
	 * @see        GregorianCalendar::constructorOIII()
	 * @see        GregorianCalendar::constructorOIIIII()
	 * @see        GregorianCalendar::constructorOIIIIII()
	 * 
	 * @author     Dominik del Bondio <ddb@bitxtender.com>
	 * @author     The ICU Project
	 */
	...
	protected function constructorO($zoneOrLocale)
	{
		...
		if($zoneOrLocale instanceof TimeZone) {
			...
			throw new InvalidArgument('Object of type ' . get_class($zoneOrLocale) . ' was not expected');
		}
	...
	/**
	 * @see        Calendar::handleComputeMonthStart
	 * 
	 * @author     Dominik del Bondio <ddb@bitxtender.com>
	 * @author     The ICU Project
	 */
	protected function handleComputeMonthStart($eyear, $month, $useMonth)
	{
		...
		$isLeap = ($eyear % 4 == 0);
		$y = $eyear - 1;
		$julianDay = 365 * $y + floor($y / 4) + (DateDefinitions::JAN_JULIAN_DAY - 3);
	...
	/**
	 * @see        Calendar::handleComputeJulianDay
	 * 
	 * @author     Dominik del Bondio <ddb@bitxtender.com>
	 * @author     The ICU Project
	 */
	...
	/**
	 * @see        Calendar::handleGetMonthLength
	 * 
	 * @author     Dominik del Bondio <ddb@bitxtender.com>
	 * @author     The ICU Project
	 */
	...
	/**
	 * @see        Calendar::handleGetYearLength
	 * 
	 * @author     Dominik del Bondio <ddb@bitxtender.com>
	 * @author     The ICU Project
	 */
	...
	/**
	 * @see        Calendar::handleGetExtendedYear
	 * 
	 * @author     Dominik del Bondio <ddb@bitxtender.com>
	 * @author     The ICU Project
	 */
	...
	/**
	 * @see        Calendar::handleGetExtendedYearFromWeekFields
	 * 
	 * @author     Dominik del Bondio <ddb@bitxtender.com>
	 * @author     The ICU Project
	 */
	...
	/**
	 * @see        Calendar::handleComputeFields
	 * 
	 * @author     Dominik del Bondio <ddb@bitxtender.com>
	 * @author     The ICU Project
	 */
	protected function handleComputeFields($julianDay)
	{
		if($julianDay >= $this->fCutoverJulianDay) {
			...
			$julianEpochDay = $julianDay - (DateDefinitions::JAN_JULIAN_DAY - 2);
	...
	private static function computeJulianDayOfYear($isGregorian, $year, &$isLeap)
	{
		$isLeap = ($year % 4 == 0);
		$y = $year - 1;
		$julianDay = 365.0 * $y + floor($y / 4) + (DateDefinitions::JAN_JULIAN_DAY - 3);
	...
	/**
	 * @see        Calendar::haveDefaultCentury
	 * 
	 * @author     Dominik del Bondio <ddb@bitxtender.com>
	 * @author     The ICU Project
	 */
	...
	/**
	 * @see        Calendar::defaultCenturyStart
	 * 
	 * @author     Dominik del Bondio <ddb@bitxtender.com>
	 * @author     The ICU Project
	 */
	...
	/**
	 * @see        Calendar::defaultCenturyStartYear
	 * 
	 * @author     Dominik del Bondio <ddb@bitxtender.com>
	 * @author     The ICU Project
	 */
