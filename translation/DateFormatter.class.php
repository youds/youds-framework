...
use YoudsFramework\Date\DateFormat;
use YoudsFramework\Date\Calendar;
 ...
 * @version    $Id$
 */
class DateFormatter extends DateFormat implements ITranslator
{
	/**
	 * @var        Locale An Locale instance.
	 */
	 ...
	 * @param      Locale The locale to use for resolving.
